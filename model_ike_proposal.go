...
type IKEProposal struct {
	...
	AuthenticationMethod    *IKEProposalAuthenticationMethod    `json:"authentication_method,omitempty"`
	...
	Group                   *IKEProposalGroup                   `json:"group,omitempty"`
...
// SetAuthenticationMethod gets a reference to the given IKEProposalAuthenticationMethod and assigns it to the AuthenticationMethod field.
...
// SetGroup gets a reference to the given IKEProposalGroup and assigns it to the Group field.
