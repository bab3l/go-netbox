...
**Utilization** | Pointer to **string** |  | [optional] [readonly] 

## Methods

### NewVLANGroup

`func NewVLANGroup(id int32, url string, displayUrl string, display string, name string, slug string, scope interface{}, created NullableTime, lastUpdated NullableTime, ) *VLANGroup`
...
`func (o *VLANGroup) HasUtilization() bool`
