...
**AuthenticationMethod** | Pointer to [**IKEProposalAuthenticationMethod**](IKEProposalAuthenticationMethod.md) |  | [optional] 
...
**Group** | Pointer to [**IKEProposalGroup**](IKEProposalGroup.md) |  | [optional] 
...
`func NewIKEProposal(id int32, url string, display string, name string, ) *IKEProposal`
...
`func (o *IKEProposal) HasAuthenticationMethod() bool`
...
`func (o *IKEProposal) HasEncryptionAlgorithm() bool`
...
`func (o *IKEProposal) HasGroup() bool`
