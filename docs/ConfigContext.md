...
`func NewConfigContext(id int32, url string, displayUrl string, display string, name string, data interface{}, created NullableTime, lastUpdated NullableTime, ) *ConfigContext`
...
`func (o *ConfigContext) HasDataPath() bool`
